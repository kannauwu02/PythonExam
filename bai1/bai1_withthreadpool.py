...
def create_csv_files(input_number, number):
    ...
    with concurrent.futures.ThreadPoolExecutor() as executor:
        ...
        for i, chunk in enumerate(chunks):
            ...
            file_name = f"numbers_{start}_{end}_pool.csv"
            futures.append(executor.submit(write_csv_file, file_name, chunk))
...
def main():
    ...
    print(f"Threadpool execution took {end_time - start_time} seconds.")
